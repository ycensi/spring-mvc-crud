 ...
 <div class="container formCli">
 	...
 	<form:form method="post" action="/SpringMVCCRUD/save"> 
 		<div class="row">
			<div class="col-md-4">
				<div class="input-group">
					...
					<form:input path="cnpj" type="number" max="999999999999999" required="true" class="form-control" />
				</div>
			</div>
		</div>
		<div class="row">
		...
		<div class="row">
			<div class="col-md-4">
				<div class="input-group">
					...
					<form:input path="maxBillingTerm" required="true" type="number" max="999" class="form-control" />
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-md-4">
				<div class="input-group">
					...
					<form:input path="companyType" required="true" type="number" max="99" class="form-control" />
				</div>
			</div>
		</div>
		<div class="row">
		...
		<div class="row">
			<div class="col-md-4">
				<div class="input-group">
					<label for="billingEmail">E-mail de Faturamento (XML)</label>
